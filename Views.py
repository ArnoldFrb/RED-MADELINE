...
class Views:
    ...
    def __init__(self, window):
        ...
        self.btnInicializarCapas = tk.Button(self.frameConfigCapas, text="Inicializar Capas", state=tk.DISABLED, command= self.Event_btnInicializarCapas,
         relief="flat", overrelief="flat", bg="#e3e3e3", borderwidth=2)
        self.btnInicializarCapas.place(relx=.785, rely=.01)
        
        tk.Label(self.frameConfigCapas, text="RATA:", bg="#fafafa").place(relx=.015, rely=.165)
        self.entNumeroCapas = tk.Entry(self.frameConfigCapas, width=5)
        self.entNumeroCapas.place(relx=.1, rely=.165)
        self.entNumeroCapas.insert(0, 3)

        tk.Label(self.frameConfigCapas, text="ERROR:", bg="#fafafa").place(relx=.303, rely=.165)
        self.entRangoA = tk.Entry(self.frameConfigCapas, width=5)
        self.entRangoA.place(relx=.4, rely=.165)
        self.entRangoA.insert(0, 10)

        tk.Label(self.frameConfigCapas, text="ITERA:", bg="#fafafa").place(relx=.615, rely=.165)
        self.entRangoB = tk.Entry(self.frameConfigCapas, width=9)
        self.entRangoB.place(relx=.7, rely=.165)
        self.entRangoB.insert(0, 15)

        self.frameConfigCapasData = tk.Frame(self.frameConfigCapas, width=450, height=130, background="#fafafa")
        self.frameConfigCapasData.place(relx=0, rely=.28)
    ...
    def Event_btnData(self):
        ...
        self.btnInicializarCapas['state'] = tk.NORMAL
    ...
    def Event_btnInicializarCapas(self):
        treeView = ttk.Treeview(self.frameConfigCapasData)
        self.CrearGrid(treeView, self.frameConfigCapasData)
        self.LlenarTabla(treeView, self.config.InicializarCapas(int(self.entNumeroCapas.get()), int(self.entRangoA.get()), int(self.entRangoB.get())))
